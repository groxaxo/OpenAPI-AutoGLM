...
[English Documentation](README.md) | [📖 使用自定义 OpenAI 模型](docs/OPENAI_COMPATIBLE.md)
...
```
访问文档，为我安装 AutoGLM
https://raw.githubusercontent.com/groxaxo/OpenAPI-AutoGLM/refs/heads/main/README_zh.md
```
