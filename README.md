...
```
  ...
  / __ \                 /\      | |       / \      / ___|| |   |  \/  |
 | |  | |_ __   ___ _ __/  \ _   _| |_ ___/ _ \    | |  _ | |   | |\/| |
 | |  | | '_ \ / _ \ '_ \/ /\ | | | __/ _ \ | | |   | | |_|| |   | |  | |
 | |__| | |_) |  __/ | | \_  \ |_| | || (_) | |_| |  | |_| || |___| |  | |
  \____/| .__/ \___|_| |_|\_\\__,_|\__\___/ \___/    \____||_____|_|  |_|
        | |
        |_|
         AI-Powered Android Phone Automation Framework
```

[中文文档](README_zh.md) | [📖 Using Custom OpenAI Models](docs/OPENAI_COMPATIBLE.md)
...
Phone Agent supports 50+ mainstream applications:
...
```bash
# Execute in the OpenAPI-AutoGLM directory
...
| Text input corrupted or missing | ADB Keyboard not enabled | Enable ADB Keyboard in system settings |
...
- **This Repository**: https://github.com/groxaxo/OpenAPI-AutoGLM
- **Original Project**: https://github.com/zai-org/Open-AutoGLM
- **Documentation**: https://github.com/groxaxo/OpenAPI-AutoGLM/blob/main/README.md
- **Issues**: https://github.com/groxaxo/OpenAPI-AutoGLM/issues
