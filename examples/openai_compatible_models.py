...
def example_custom_openai_compatible():
    ...
    model_config = ModelConfig(
        ...
        api_key="your-custom-api-key",  # Or "EMPTY" if no auth required
...
def example_with_environment_variables():
    ...
    # export PHONE_AGENT_API_KEY="your-openai-api-key"
    ...
    os.environ["PHONE_AGENT_API_KEY"] = "your-openai-api-key"
